...
async def plan_strategy(state: WorkflowState) -> dict:
    ...
    emit_in_pipeline(session_id, "StrategyAgent", f"Designing multi-segment approach for {len(segments)} targets", "Analyzing segment data")
    ...
    emit_in_pipeline(session_id, "StrategyAgent", "Strategy finalized. Establishing priority logic.", "Aligning angles per segment")
