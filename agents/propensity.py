...
class PropensityModel:
    def __init__(self):
        # Priors for Bayesian update
        self.PRIOR_ALPHA = 2.0
        self.PRIOR_BETA = 18.0 # Assumes roughly 10% base engagement probability
    ...
    def compute_engagement_score(self, user: dict) -> float:
        ...
        # Blend standard demographic prior with actual historical click rate
